...
DATABASES = {
    ...
    #     'NAME': BASE_DIR / 'db.sqlite3',
    # }
    'default': REMOTE if os.getenv('LOCAL') == 'false' else LOCAL
}
...
# Настройки Djoser
DJOSER = {
    'LOGIN_FIELD': 'email',               # Логин по email
...
TIME_ZONE = 'Europe/Moscow'  # 'UTC' было, для правильной записи времени в БД поменяли на 'RU'
